...
describe('apiCall', () => {
    ...
    describe('init', () => {
        ...
        it('Should repeat the file if the repeat tag is present change the it text', () => {
            ...
            const apiCallConfig = new ApiCall('./fixtures/fixture.repeat.spec.yaml', apiPort, fakeIt)
        ...
        it('Should call the only method if the only tag is present', () => {
            ...
            const apiCallConfig = new ApiCall('./fixtures/fixture.only.spec.yaml', apiPort, {
                skip: fakeSkip,
                only: fakeOnly
            })
        ...
        it('Should call the skip method if the only tag is present', () => {
            const fakeSkip = sinon.spy()
            const fakeOnly = sinon.spy()
            const apiCallConfig = new ApiCall('./fixtures/fixture.skip.spec.yaml', apiPort, {
                skip: fakeSkip,
                only: fakeOnly
            })
